...
from train.train_maxent import *
from model.maxent import *
from eval import *
...
def main(args, device):
    ...
    # train model
    if args.data_name == 'yaleb':       model = train_maxent(args, train_loader, test_loader, model, device, model_file_name)
    ...
    if args.data_name == 'yaleb': return model, data
...
def evaluation(args, device, eval_model, model=None, is_e2e=True, trainset=None, testset=None):
    ...
    if is_e2e:
        ...
        y_pred, y_acc, s_acc, s_pred, cf = z_evaluator(args, model, None, device, eval_model, 'maxent', trainset, testset)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default='maxent', help="Model ID")
