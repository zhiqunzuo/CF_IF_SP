...
def main():
    ...
    a, x, y, w_u, cov_x, w_a, b = sample(N, d_u, d_x)
    ...
    print("CF")
    print("mse = {} + {}, acc = {} + {}, if = {} + {}".format(np.mean(cf_mses), np.std(cf_mses),
                                                              np.mean(cf_accs), np.std(cf_accs),
                                                              np.mean(cf_cofs), np.std(cf_cofs)))
    print("UF")
    print("mse = {} + {}, acc = {} + {}, if = {} + {}".format(np.mean(uf_mses), np.std(uf_mses),
                                                              np.mean(uf_accs), np.std(uf_accs),
                                                              np.mean(uf_cofs), np.std(uf_cofs)))
    print("GLIF")
    print("mse = {} + {}, acc = {} + {}, if = {} + {}".format(np.mean(if_mses), np.std(if_mses),
